...
export default function Profile() {
  ...
  return (
    <section ref={profileRef} className="flex flex-col m-4 lg:mx-8 bg-[#a5a5a5]/20">
    <div className="p-4 my-1 bg-gradient-to-b from-[#a5a5a5]/60 via-[#a5a5a5]/40 to-transparent rounded-md">
