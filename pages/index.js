...
<div className="max-w-md mx-auto sm:max-w-lg md:max-w-lg lg:max-w-xl xl:max-w-2xl flex bg-gradient-to-b from-gray-400 to-[#cdcdcd] border-black rounded shadow-md overflow-hidden">
