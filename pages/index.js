    ...
    <div className="min-h-screen font-mono bg-gradient-to-br from-[#f5f5f5] via-[#e5e5e5] to-[#d5d5d5] text-black relative">
      <main className="pt-20">
        ...
        <section ref={secondSectionRef} className="flex my-4">
          <motion.div
            className="w-full h-85 md:h-60 flex bg-gradient-to-b from-neutral-300 to-[#cdcdcd] border-black shadow-md overflow-hidden"
            initial="hidden"
          ...
          >
            ...
            >
              <Image
                src={Helmet}
                alt="Helmet"
                className="object-contain h-full w-full p-0 m-0 blur-xs"
              />
            </motion.div>
