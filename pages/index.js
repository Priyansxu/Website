...
<div className="max-w-md mx-auto sm:max-w-lg md:max-w-lg lg:max-w-xl xl:max-w-2xl flex bg-gradient-to-b from-[#B3B6BF] to-[#E4DFE6] border-black rounded shadow-md overflow-hidden">
