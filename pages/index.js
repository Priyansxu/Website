...
<div className="max-w-md mx-auto sm:max-w-lg md:max-w-lg lg:max-w-xl xl:max-w-2xl flex bg-gradient-to-br from-[#d0d0d0] via-[#bebebe] to-[#a5a5a5] border border-[#dfded1] rounded drop-shadow-xl overflow-hidden">
