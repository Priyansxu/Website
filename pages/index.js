...
export default function Page() {
  ...
  <div className="flex flex-col md:flex-row-reverse mt-6 bg-gradient-to-b from-neutral-300 to-[#cdcdcd] border-black rounded shadow-md overflow-hidden">
    ...
    <div className="flex-grow pr-4 text-black text-xs justify-center text-left place-items-center">
      <p className="my-2 py-4">
        Priyanshu Gupta, born in 2007. A passionate explorer of programming, graphic design, psychology, and space. Always pushing the boundaries of creativity.
      </p>
    </div>
