    ...
    <div className="min-h-screen font-mono bg-gradient-to-br from-[#f5f5f5] via-[#e5e5e5] to-[#d5d5d5] text-[#4B5462] relative">
      <main className="pt-20">
        ...
        <section ref={secondSectionRef} className="flex my-4">
          <motion.div
            className="mx-4 md:mx-0 w-150 rounded-md md:rounded-none md:w-full h-85 md:h-90 flex bg-gradient-to-b from-[a5a5a5] via-neutral-300 to-[#cdcdcd] border border-t-3 border-[#4B5462] shadow-md overflow-hidden"
            initial="hidden"
