...
export default function Page() {
  ...
  return (
   <div className="min-h-screen font-mono bg-gradient-to-br from-[#f5f5f5] via-[#e5e5e5] to-[#d5d5d5] text-black relative">
     ...
     <section className="flex flex-col md:flex-row my-6 mx-4 md:mx-15">
  <div className="max-w-md mx-auto sm:max-w-lg md:max-w-lg lg:max-w-xl xl:max-w-2xl flex bg-gradient-to-b from-neutral-300 to-[#cdcdcd] border-black rounded shadow-md overflow-hidden w-full md:w-1/2 h-48">
  ...
  <div className="max-w-md mx-auto sm:max-w-lg md:max-w-lg lg:max-w-xl xl:max-w-2xl mt-6 bg-gradient-to-b from-neutral-300 to-[#cdcdcd] border-black rounded shadow-md overflow-hidden w-full md:w-1/2 h-48">
    <div className="flex-none w-1/3">
      <Image 
        src={Helmet}
        alt="Helmet"
