...
export default function Page() {
  ...
  <div className="max-w-md mx-auto sm:max-w-lg md:max-w-lg lg:max-w-xl xl:max-w-2xl mt-6 bg-gradient-to-b from-neutral-300 to-[#cdcdcd] border-black rounded shadow-md overflow-hidden">
    <div className="flex-none w-1/3">
      <Image 
        src={Helmet}
        alt="Helmet"
